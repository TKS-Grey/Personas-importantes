const datos = {
    walala: {
        ...
        <video class="videoFullscreen" controls width="400" height="300">
            <source src="thank_you_music_toma_el_mundo.mp4" type="video/mp4">
        </video>
        
        TKM walala, aunque me webeaia caleta si, pero igual te quiero caleta. Gracias por ser mi amigo, y espero que sigamos siendo amigos por mucho tiempo más.
        stuppid nigger`
    },
    ...
    suricata: {
        ...
        Hola, se que en general no hablamos tanto cómo antes, debido a que tu ahora trabajas y yo estoy en el Tp.
    ...
    toti: {
        ...
        textoHTML: `
            ...
            <video class="videoFullscreen" controls width="400" height="300">
                <source src="ten_mi_mano.mp4" type="video/mp4">
            </video>
            ...
            <p>Espero que este mensajito haya sido de tu agrado y que te haya alegrado el día :D, adios</p>
...
function activarPantallaCompleta() {
    const videos = document.querySelectorAll(".videoFullscreen");
